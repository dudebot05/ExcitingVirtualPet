...
namespace ExcitingVirtualPetCore
{
    class Dog : IAnimal
    {
        private const int MAX_HUNGER = 20;
        ...
        private const int MAX_BOREDOM = 20;
        ...
        private BitmapImage normalImage = new BitmapImage(new Uri("Resources/basic_dog.jpg", UriKind.Relative));
        private BitmapImage leavingImage = new BitmapImage(new Uri("Resources/dog_leaving.jpg", UriKind.Relative));
        private BitmapImage sleepingImage = new BitmapImage(new Uri("Resources/dog_sleeping.jpg", UriKind.Relative));
        ...
        public Dog(Load dog)
        {
            ...
            tiredness = dog.tiredness;
            currentFood = dog.currentFood;
            currentWater = dog.currentWater;
        }

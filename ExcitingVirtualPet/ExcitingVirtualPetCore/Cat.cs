...
namespace ExcitingVirtualPetCore
{
    ...
    class Cat : IAnimal
    {
        ...
        private const int MAX_TIREDNESS = 20;
        ...
        private BitmapImage normalImage = new BitmapImage(new Uri("Resources/basic_cat.jpg", UriKind.Relative));
        private BitmapImage leavingImage = new BitmapImage(new Uri("Resources/cat_leaving.jpg", UriKind.Relative));
        private BitmapImage sleepingImage = new BitmapImage(new Uri("Resources/cat_sleeping.jpg", UriKind.Relative));
        ...
        public Cat(Load cat)
        {
            ...
            tiredness = cat.tiredness;
            currentFood = cat.currentFood;
            currentWater = cat.currentWater;
        }
